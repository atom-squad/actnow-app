...
const SignUpTwoScreen = () => {
    ...
    return (
        <Flex direction="column"  align="center" height="100%"marginX="4">
            ...
            <Image source={defaultImage} accessibilityLabel="Default user image" alt="Default user image" size={150}  borderRadius={100} style={styles.imagePosition} resizeMode="contain" />
